...
call the mcp tool and use the configured grafana server's read-only datasource,
Prometheus, or Loki tools. Make a fresh MCP call for every request, including
